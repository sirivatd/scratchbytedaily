    ...
    <View style={{ flex: 1 }}>
      ...
      >
        ...
        canvasStyles={{
          ...
          borderRadius={16}
        /> */}
        {isPlaying && <ScratchCard />}
        {!isPlaying && <ScratchCardPreview />}
      </View>
      <View
        style={{
          position: "absolute",
      ...
      >
        <Image
          src='https://firebasestorage.googleapis.com/v0/b/qfluence.appspot.com/o/advanced_backdrop.png?alt=media&token=db2facfb-8ef2-490b-b284-5bd8c8d7dbce'
      ...
      >
        ...
        >
          <Text>{isPlaying ? 'Cancel' : 'Play'}</Text>
        </Button>
        <Text style={{ color: "white" }}>May 21, 2024</Text>
